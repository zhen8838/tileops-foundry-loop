...
def run_row(row):
    ...
    callables = {
        ...
        "official_2.3.1": official_call,
    }
    orders = [
        ("base_incumbent", "candidate", "official_2.3.1"),
        ("official_2.3.1", "base_incumbent", "candidate"),
        ("candidate", "official_2.3.1", "base_incumbent"),
    ]
...
def main():
    ...
    official_geo = math.prod(
        row["summary"]["official_2.3.1"]["median_of_trial_medians_ms"] for row in rows
    ) ** (1 / len(rows))
    result = {
