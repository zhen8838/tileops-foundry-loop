...
extern "C" __global__ void __launch_bounds__(512, 1) tilelang_fused_chunk_gdr_fwd_kernel_kernel(__grid_constant__ const CUtensorMap a_desc, const bfloat16_t* __restrict__ b, const int* __restrict__ chunk_offsets, const int* __restrict__ cp_seq_map, const int* __restrict__ cu_seqlens, const bfloat16_t* __restrict__ g, const float* __restrict__ h0, float* __restrict__ ht, __grid_constant__ const CUtensorMap k_desc, bfloat16_t* __restrict__ o, __grid_constant__ const CUtensorMap o_desc, __grid_constant__ const CUtensorMap q_desc, const int* __restrict__ raw_cu_seqlens, __grid_constant__ const CUtensorMap v_desc, int batch_size, int num_tokens, int raw_batch_size) {
  ...
  void* p_shared = ((void*)((char*)buf_dyn_shmem + 122880));
  void* vd_shared = ((void*)((char*)buf_dyn_shmem + 131072));
  void* vn_shared = ((void*)((char*)buf_dyn_shmem + 139264));
  ...
  __syncthreads();
  batch_idx = 0;
  seq_start_idx = cu_seqlens[(((int64_t)((int)blockIdx.x)) >> (int64_t)7)];
  seq_end_idx = cu_seqlens[((((int64_t)((int)blockIdx.x)) >> (int64_t)7) + (int64_t)1)];
  chunk_start_idx = chunk_offsets[(((int64_t)((int)blockIdx.x)) >> (int64_t)7)];
  raw_batch_idx = cp_seq_map[(((int64_t)((int)blockIdx.x)) >> (int64_t)7)];
  int condval;
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_s = 0; i_s < num_iters; ++i_s) {
      ...
      bar_5[0].wait((i_s & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b, (&(((bfloat16_t*)vn_shared)[0])));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(h_fragment + 0), 64);
        tl::warpgroup_arrive();
        ...
        for (int i_3 = 0; i_3 < 2; ++i_3) {
          ...
          for (int ki = 0; ki < 4; ++ki) {
            tl::wgmma_ss<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a + (((i_3 * 8192) + (ki * 2048)) >> 4)), uint64_t(desc_b + ((ki * 2048) >> 4)), ((uint32_t*)(h_fragment + (i_3 * 32))), 1);
          }
        }
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int i_s_1 = 0; i_s_1 < num_iters; ++i_s_1) {
        ...
        bar_1[0].wait((i_s_1 & 1));
        {
          ...
          tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_1, (&(((bfloat16_t*)h_shared)[0])));
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(u_fragment + 0), 32);
          tl::warpgroup_arrive();
          tl::fence_proxy_async();
          #pragma unroll
          for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
            tl::wgmma_ss<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_1 + ((((ki_1 >> 2) * 8192) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), ((uint32_t*)(u_fragment + 0)), ((0 < ki_1) ? 1 : 0));
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(u_fragment + 0), 32);
        ...
        for (int i_6 = 0; i_6 < 16; ++i_6) {
          *(uint1*)(v_shared_local_cast + 0) = *(uint1*)(((bfloat16_t*)v_shared) + ((((((((((i_s_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_6 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_6 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_6 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_6 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
          float2 __2;
        ...
        for (int i_7 = 0; i_7 < 16; ++i_7) {
          ...
          *(uint1*)(((bfloat16_t*)v_shared) + ((((((((((i_s_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_7 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_7 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_7 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_7 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(uint1*)(v_shared_local_cast_1 + 0);
        }
        bar_3[0].wait((i_s_1 & 1));
        {
          ...
          tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_2, (&(((bfloat16_t*)v_shared)[((i_s_1 & 1) * 4096)])));
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(v_fragment + 0), 32);
          tl::warpgroup_arrive();
          tl::fence_proxy_async();
          #pragma unroll
          for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
            tl::wgmma_ss<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_2 + ((ki_2 * 32) >> 4)), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), ((uint32_t*)(v_fragment + 0)), ((0 < ki_2) ? 1 : 0));
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(v_fragment + 0), 32);
        ...
        for (int i_8 = 0; i_8 < 4; ++i_8) {
          tl::ptx_stmatrix_m8n8_x4((&(((bfloat16_t*)vd_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_8 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((bfloat16_t)v_fragment[(i_8 * 8)]), ((bfloat16_t)v_fragment[((i_8 * 8) + 1)])), __pack_half2(((bfloat16_t)v_fragment[((i_8 * 8) + 2)]), ((bfloat16_t)v_fragment[((i_8 * 8) + 3)])), __pack_half2(((bfloat16_t)v_fragment[((i_8 * 8) + 4)]), ((bfloat16_t)v_fragment[((i_8 * 8) + 5)])), __pack_half2(((bfloat16_t)v_fragment[((i_8 * 8) + 6)]), ((bfloat16_t)v_fragment[((i_8 * 8) + 7)])));
        }
        bar_4[0].arrive();
        #pragma unroll
        ...
        for (int i_10 = 0; i_10 < 4; ++i_10) {
          tl::ptx_stmatrix_m8n8_x4((&(((bfloat16_t*)vn_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_10 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((bfloat16_t)v_fragment[(i_10 * 8)]), ((bfloat16_t)v_fragment[((i_10 * 8) + 1)])), __pack_half2(((bfloat16_t)v_fragment[((i_10 * 8) + 2)]), ((bfloat16_t)v_fragment[((i_10 * 8) + 3)])), __pack_half2(((bfloat16_t)v_fragment[((i_10 * 8) + 4)]), ((bfloat16_t)v_fragment[((i_10 * 8) + 5)])), __pack_half2(((bfloat16_t)v_fragment[((i_10 * 8) + 6)]), ((bfloat16_t)v_fragment[((i_10 * 8) + 7)])));
        }
        bar_5[0].arrive();
      ...
      if (((int)threadIdx.x) < 384) {
        ...
        for (int i_s_2 = 0; i_s_2 < num_iters; ++i_s_2) {
          ...
          bar_1[0].wait((i_s_2 & 1));
          {
            ...
            tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((bfloat16_t*)h_shared)[0])));
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_fragment + 0), 32);
            tl::warpgroup_arrive();
            tl::fence_proxy_async();
            #pragma unroll
            for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
              tl::wgmma_ss<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_4 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), ((uint32_t*)(o_fragment + 0)), ((0 < ki_4) ? 1 : 0));
            }
            tl::warpgroup_commit_batch();
            tl::warpgroup_wait<0>();
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_fragment + 0), 32);
          ...
          bar_4[0].wait((i_s_2 & 1));
          {
            ...
            tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_5, (&(((bfloat16_t*)vd_shared)[0])));
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_fragment + 0), 32);
            tl::warpgroup_arrive();
            tl::fence_proxy_async();
            #pragma unroll
            for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
              tl::wgmma_ss<tl::DataType::kBFloat16, tl::DataType::kBFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_5 + ((ki_5 * 32) >> 4)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), ((uint32_t*)(o_fragment + 0)), 1);
            }
            tl::warpgroup_commit_batch();
            tl::warpgroup_wait<0>();
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_fragment + 0), 32);
        ...
        if (((int)threadIdx.x) < 416) {
          for (int i_s_3 = 0; i_s_3 < num_iters; ++i_s_3) {
            ...
            if (tl::tl_shuffle_elect<32>()) {
              ...
              tl::tma_load(q_desc, data_is_ready[(i_s_3 & 1)], (&(((bfloat16_t*)q_shared)[((i_s_3 & 1) * 8192)])), 0, left, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
              tl::tma_load(q_desc, data_is_ready[(i_s_3 & 1)], (&(((bfloat16_t*)q_shared)[(((i_s_3 & 1) * 8192) + 4096)])), 64, left, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
              data_is_ready[(i_s_3 & 1)].expect_transaction(16384);
              tl::tma_load(k_desc, data_is_ready[(i_s_3 & 1)], (&(((bfloat16_t*)k_shared)[((i_s_3 & 1) * 8192)])), 0, left, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
              tl::tma_load(k_desc, data_is_ready[(i_s_3 & 1)], (&(((bfloat16_t*)k_shared)[(((i_s_3 & 1) * 8192) + 4096)])), 64, left, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
            }
          ...
          if (((int)threadIdx.x) < 448) {
            for (int i_s_4 = 0; i_s_4 < num_iters; ++i_s_4) {
              ...
              if (tl::tl_shuffle_elect<32>()) {
                ...
                tl::fence_proxy_async();
                tl::tma_load(v_desc, data_is_ready[(i_s_4 & 1)], (&(((bfloat16_t*)v_shared)[((i_s_4 & 1) * 4096)])), ((((int)blockIdx.x) & 1) * 64), left_1, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
              }
              if ((left_1 + 64) <= seq_end_idx) {
                ...
                for (int i_21 = 0; i_21 < 2; ++i_21) {
                  ...
                  if (((((13 <= (((left_1 + ((int)threadIdx.x)) >> 5) + i_21)) && ((((i_21 * 32) + left_1) + ((int)threadIdx.x)) < (num_tokens + 416))) && (0 <= batch_idx)) && (batch_idx < 1))) {
                    condval_2 = b[((((((((int64_t)i_21) * (int64_t)2048) + (((int64_t)left_1) * (int64_t)64)) + (((int64_t)((int)threadIdx.x)) * (int64_t)64)) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)64)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) >> (int64_t)1)) - (int64_t)26624)];
                  } else {
                ...
                for (int i_22 = 0; i_22 < 2; ++i_22) {
                  if ((((i_22 * 32) + left_1) + ((int)threadIdx.x)) < (seq_end_idx + 416)) {
                    ...
                    if (((((13 <= (((left_1 + ((int)threadIdx.x)) >> 5) + i_22)) && ((((i_22 * 32) + left_1) + ((int)threadIdx.x)) < (num_tokens + 416))) && (0 <= batch_idx)) && (batch_idx < 1))) {
                      condval_3 = b[((((((((int64_t)i_22) * (int64_t)2048) + (((int64_t)left_1) * (int64_t)64)) + (((int64_t)((int)threadIdx.x)) * (int64_t)64)) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)64)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) >> (int64_t)1)) - (int64_t)26624)];
                    } else {
            ...
            if (((int)threadIdx.x) < 480) {
              for (int i_s_5 = 0; i_s_5 < num_iters; ++i_s_5) {
                ...
                if (tl::tl_shuffle_elect<32>()) {
                  ...
                  tl::fence_proxy_async();
                  tl::tma_load(a_desc, data_is_ready[(i_s_5 & 1)], (&(((bfloat16_t*)a_shared)[((i_s_5 & 1) * 4096)])), 0, left_2, ((((int)blockIdx.x) & 127) >> 1), batch_idx);
                }
                if ((left_2 + 64) <= seq_end_idx) {
                  ...
                  for (int i_23 = 0; i_23 < 2; ++i_23) {
                    ...
                    if (((((14 <= (((left_2 + ((int)threadIdx.x)) >> 5) + i_23)) && ((((i_23 * 32) + left_2) + ((int)threadIdx.x)) < (num_tokens + 448))) && (0 <= batch_idx)) && (batch_idx < 1))) {
                      condval_4 = g[((((((((int64_t)i_23) * (int64_t)2048) + (((int64_t)left_2) * (int64_t)64)) + (((int64_t)((int)threadIdx.x)) * (int64_t)64)) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)64)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) >> (int64_t)1)) - (int64_t)28672)];
                    } else {
                  ...
                  for (int i_24 = 0; i_24 < 2; ++i_24) {
                    if ((((i_24 * 32) + left_2) + ((int)threadIdx.x)) < (seq_end_idx + 448)) {
                      ...
                      if (((((14 <= (((left_2 + ((int)threadIdx.x)) >> 5) + i_24)) && ((((i_24 * 32) + left_2) + ((int)threadIdx.x)) < (num_tokens + 448))) && (0 <= batch_idx)) && (batch_idx < 1))) {
                        condval_5 = g[((((((((int64_t)i_24) * (int64_t)2048) + (((int64_t)left_2) * (int64_t)64)) + (((int64_t)((int)threadIdx.x)) * (int64_t)64)) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)64)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) >> (int64_t)1)) - (int64_t)28672)];
                      } else {
                      ...
                      if (((((1 <= seq_end_idx) && (seq_end_idx <= num_tokens)) && (0 <= batch_idx)) && (batch_idx < 1))) {
                        condval_6 = g[((((((int64_t)seq_end_idx) * (int64_t)64) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)64)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) >> (int64_t)1)) - (int64_t)64)];
                      } else {
              ...
              for (int i_s_6 = 0; i_s_6 < num_unmasked_iters; ++i_s_6) {
                ...
                if (0 < i_s_6) {
                  if (tl::tl_shuffle_elect<32>()) {
                    tl::tma_store(o_desc, (&(((bfloat16_t*)o_shared)[0])), ((((int)blockIdx.x) & 1) * 64), (right - 64), ((((int)blockIdx.x) & 127) >> 1), batch_idx);
                    tl::tma_store_arrive();
              ...
              if (num_unmasked_iters < num_iters) {
                ...
                if (0 < num_unmasked_iters) {
                  if (tl::tl_shuffle_elect<32>()) {
                    tl::tma_store(o_desc, (&(((bfloat16_t*)o_shared)[0])), ((((int)blockIdx.x) & 1) * 64), (seq_split_idx - 64), ((((int)blockIdx.x) & 127) >> 1), batch_idx);
                    tl::tma_store_arrive();
                    tl::tma_store_wait<0, true>();
                  }
                }
              ...
              if (0 <= batch_idx) {
                ...
                for (int i_25 = 0; i_25 < 16; ++i_25) {
                  if ((((i_25 * 4) + (((int)threadIdx.x) >> 3)) + seq_split_idx) < (seq_end_idx + 60)) {
                    if (15 <= ((((((int)threadIdx.x) >> 3) + seq_split_idx) >> 2) + i_25)) {
                      if ((((i_25 * 4) + (((int)threadIdx.x) >> 3)) + seq_split_idx) < (num_tokens + 60)) {
                        if (batch_idx < 1) {
                          *(uint4*)(o + (((((((((int64_t)i_25) * (int64_t)32768) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)3) * (int64_t)8192)) + (((int64_t)seq_split_idx) * (int64_t)8192)) + ((((int64_t)batch_idx) * ((int64_t)num_tokens)) * (int64_t)8192)) + ((((int64_t)((int)blockIdx.x)) & (int64_t)127) * (int64_t)64)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)7) * (int64_t)8)) - (int64_t)491520)) = *(uint4*)(((bfloat16_t*)o_shared) + ((((((i_25 >> 1) * 512) + (((((i_25 * 4) + (((int)threadIdx.x) >> 3)) + 4) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_25 & 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)));
                        }
                      }
                    }
                  }
