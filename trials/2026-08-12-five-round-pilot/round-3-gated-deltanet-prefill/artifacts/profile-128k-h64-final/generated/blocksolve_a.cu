...
extern "C" __global__ void __launch_bounds__(32, 1) prefill_blocksolve_A_bthd_tl_kernel(bfloat16_t* __restrict__ A, const bfloat16_t* __restrict__ beta, const bfloat16_t* __restrict__ g, const bfloat16_t* __restrict__ k) {
  ...
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    ((bfloat16_t*)g_s)[((i * 32) + ((int)threadIdx.x))] = g[((((((int)blockIdx.z) * 4096) + (i * 2048)) + (((int)threadIdx.x) * 64)) + ((int)blockIdx.y))];
  }
  #pragma unroll
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    ((bfloat16_t*)beta_s)[((i_1 * 32) + ((int)threadIdx.x))] = beta[((((((int)blockIdx.z) * 4096) + (i_1 * 2048)) + (((int)threadIdx.x) * 64)) + ((int)blockIdx.y))];
  }
  #pragma unroll
  ...
  for (int kt = 0; kt < 2; ++kt) {
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)k0)[(((((i_12 * 256) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_12 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(k[((((((((int)blockIdx.z) * 524288) + (i_12 * 32768)) + ((((int)threadIdx.x) >> 3) * 8192)) + (((int)blockIdx.y) * 128)) + (kt * 64)) + ((((int)threadIdx.x) & 7) * 8))])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)k1)[(((((i_13 * 256) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(k[(((((((((int)blockIdx.z) * 524288) + (i_13 * 32768)) + ((((int)threadIdx.x) >> 3) * 8192)) + (((int)blockIdx.y) * 128)) + (kt * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 131072)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_14 = 0; i_14 < 4; ++i_14) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)k2)[(((((i_14 * 256) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_14 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(k[(((((((((int)blockIdx.z) * 524288) + (i_14 * 32768)) + ((((int)threadIdx.x) >> 3) * 8192)) + (((int)blockIdx.y) * 128)) + (kt * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      tl::cp_async_gs<16>((&(((bfloat16_t*)k3)[(((((i_15 * 256) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_15 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(k[(((((((((int)blockIdx.z) * 524288) + (i_15 * 32768)) + ((((int)threadIdx.x) >> 3) * 8192)) + (((int)blockIdx.y) * 128)) + (kt * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 393216)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<0>();
    __syncthreads();
  ...
  *(uint1*)(((bfloat16_t*)beta_f_s) + (((int)threadIdx.x) * 2)) = *(uint1*)(((bfloat16_t*)beta_s) + (((int)threadIdx.x) * 2));
  ...
  __syncthreads();
  *(uint4*)(A + ((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8))) = *(uint4*)(((bfloat16_t*)i_s) + (((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 65536)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 256));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 65552)) = *(uint4*)(((bfloat16_t*)i_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 256));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 131072)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 768));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 131088)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 1024));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 131104)) = *(uint4*)(((bfloat16_t*)i_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 512));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 196608)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 1536));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 196624)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 1792));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 196640)) = *(uint4*)(((bfloat16_t*)a_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 2048));
  *(uint4*)(A + (((((((int)blockIdx.z) * 262144) + ((((int)threadIdx.x) >> 1) * 4096)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 196656)) = *(uint4*)(((bfloat16_t*)i_s) + ((((((int)threadIdx.x) >> 1) * 16) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 768));
}
