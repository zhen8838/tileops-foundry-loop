...
extern "C" __global__ void __launch_bounds__(256, 1) _fft_lut_main_kernel(const float* __restrict__ lut_imag, const float* __restrict__ lut_real, const float* __restrict__ x_pair, float* __restrict__ y_imag, float* __restrict__ y_real) {
  ...
  if (((0 <= rev_idx) && (rev_idx < 4096))) {
    condval = x_pair[(((int64_t)rev_idx) * (int64_t)2)];
  } else {
  ...
  float condval_1;
  if (((0 <= rev_idx) && (rev_idx < 4096))) {
    condval_1 = x_pair[((((int64_t)rev_idx) * (int64_t)2) + (int64_t)1)];
  } else {
  ...
  if (((0 <= rev_idx_1) && (rev_idx_1 < 4096))) {
    condval_2 = x_pair[(((int64_t)rev_idx_1) * (int64_t)2)];
  } else {
  ...
  float condval_3;
  if (((0 <= rev_idx_1) && (rev_idx_1 < 4096))) {
    condval_3 = x_pair[((((int64_t)rev_idx_1) * (int64_t)2) + (int64_t)1)];
  } else {
  ...
  y_real[((((int)blockIdx.x) * 512) + ((int)threadIdx.x))] = value_real;
  y_imag[((((int)blockIdx.x) * 512) + ((int)threadIdx.x))] = value_imag;
  float value_real_1 = ((float*)smem_r)[(((int)threadIdx.x) + 256)];
  float value_imag_1 = ((float*)smem_i)[(((int)threadIdx.x) + 256)];
  y_real[(((((int)blockIdx.x) * 512) + ((int)threadIdx.x)) + 256)] = value_real_1;
  y_imag[(((((int)blockIdx.x) * 512) + ((int)threadIdx.x)) + 256)] = value_imag_1;
}
...
extern "C" __global__ void __launch_bounds__(256, 1) _fft_lut_main_kernel_1(const float* __restrict__ lut_imag, const float* __restrict__ lut_real, const float* __restrict__ y_imag, float* __restrict__ y_pair, const float* __restrict__ y_real) {
  ...
  float pair_6[2];
  float pair_7[2];
  float x0_r = y_real[((((int)blockIdx.x) * 256) + ((int)threadIdx.x))];
  float x0_i = y_imag[((((int)blockIdx.x) * 256) + ((int)threadIdx.x))];
  float x1_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 512)];
  float x1_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 512)];
  float x2_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 1024)];
  float x2_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 1024)];
  float x3_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 1536)];
  float x3_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 1536)];
  float x4_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 2048)];
  float x4_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 2048)];
  float x5_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 2560)];
  float x5_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 2560)];
  float x6_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 3072)];
  float x6_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 3072)];
  float x7_r = y_real[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 3584)];
  float x7_i = y_imag[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) + 3584)];
  ...
  *(float2*)(y_pair + ((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2))) = *(float2*)(pair + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 1024)) = *(float2*)(pair_1 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 2048)) = *(float2*)(pair_2 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 3072)) = *(float2*)(pair_3 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 4096)) = *(float2*)(pair_4 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 5120)) = *(float2*)(pair_5 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 6144)) = *(float2*)(pair_6 + 0);
  ...
  *(float2*)(y_pair + (((((int)blockIdx.x) * 512) + (((int)threadIdx.x) * 2)) + 7168)) = *(float2*)(pair_7 + 0);
}
