...
extern "C" __global__ void __launch_bounds__(512, 1) _fft_lut_main_kernel_1(const float* __restrict__ lut_imag, const float* __restrict__ lut_real, const float* __restrict__ y_imag, float* __restrict__ y_pair, const float* __restrict__ y_real) {
  ...
  #pragma unroll
  for (int i = 0; i < 2; ++i) {
    float a_r = y_real[(((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x))];
    float a_i = y_imag[(((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x))];
    float b_r = y_real[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 1024)];
    float b_i = y_imag[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 1024)];
    float c_r = y_real[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 2048)];
    float c_i = y_imag[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 2048)];
    float d_r = y_real[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 3072)];
    float d_i = y_imag[((((((int)blockIdx.y) * 4096) + (i * 512)) + ((int)threadIdx.x)) + 3072)];
    ...
    *(float2*)(y_pair + (((((int)blockIdx.y) * 8192) + (i * 1024)) + (((int)threadIdx.x) * 2))) = *(float2*)(pair + 0);
    ...
    *(float2*)(y_pair + ((((((int)blockIdx.y) * 8192) + (i * 1024)) + (((int)threadIdx.x) * 2)) + 4096)) = *(float2*)(pair_1 + 0);
    ...
    *(float2*)(y_pair + ((((((int)blockIdx.y) * 8192) + (i * 1024)) + (((int)threadIdx.x) * 2)) + 2048)) = *(float2*)(pair_2 + 0);
    ...
    *(float2*)(y_pair + ((((((int)blockIdx.y) * 8192) + (i * 1024)) + (((int)threadIdx.x) * 2)) + 6144)) = *(float2*)(pair_3 + 0);
  }
}
